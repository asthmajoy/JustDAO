    ...
    UUPSUpgradeable
{
    ...
    /**
     * @notice Initializes the contract with only a token address (simplified version)
     * @dev This function exists for backward compatibility with tests/scripts
     * @param tokenAddress Address of the JustToken contract
     */
    function initializeWithToken(address tokenAddress) external initializer {
        initialize(tokenAddress, address(0), address(0), msg.sender);
    }
